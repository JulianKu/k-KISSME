...
def averagePooling(img):
    ...
    img_pool = img[0::2] + img[1::2] # adds two consecutive rows
    img_pool = img_pool[:, 0::2] + img_pool[:, 1::2] # adds to consecutive columns

    img_pool = img_pool // 4 # average over the four pixels that were pooled
